...
@section('page-title', 'Новая системная категория')

@php
    $palette = \App\Http\Controllers\CategoryController::PALETTE;
    $current = old('color', $palette[0]);
@endphp

@section('content')
    <x-admin.page-header
        title="Новая системная категория"
        subtitle="Системные категории доступны всем пользователям.">
        <x-slot:actions>
