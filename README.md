...
- Экспорт отчёта в PDF через системный диалог печати браузера
...
- [X] **Этап 06 (доп.)** — Админ-дашборд с системными агрегатами и экспортом отчёта в PDF (через `window.print()`)
