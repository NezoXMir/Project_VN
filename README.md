...
### Для пользователя
- Постановка целей в 4 категориях: учёба, спорт, работа, другое
...
### Для администратора
- Отдельная панель `/admin`
- Управление ролями пользователей (защита: нельзя понизить последнего admin)
- Просмотр агрегированной статистики системы
- **Без доступа** к персональным данным пользователей
...
- [ ] **Этап 02** — Аутентификация: регистрация, вход, RBAC (user / admin)
